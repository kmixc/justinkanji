...
export default function About() {
    return (
        <div>
            <div className='w-4/6 bg-red-400 m-auto lg:my-24 sm:my-12 max-sm:my-12'>
                <div className='text-black flex justify-center items-center font-bold flex-col py-20 lg:px-32 max-sm:px-10'>
                    <h2 className='lg:text-5xl sm:text-3xl max-sm:text-3xl pb-8 text-white'>@
                        <span className='text-green-700'>justinkanji</span>
                    </h2>
                    <ul>
                        <li className='list-disc lg:text-3xl sm:text-xl max-sm:text-xl'>
                        ...
                        <li className='list-disc lg:text-3xl sm:text-xl max-sm:text-xl'>
                            Justin has graduated with a degree in Honors <span className='text-white'>Bachelor of Global Business & Digital Arts (GBDA)</span>
                        </li>
                        <li className='list-disc lg:text-3xl sm:text-xl max-sm:text-xl'>
            ...
            <div className='lg:w-3/5 sm:w-4/5 max-sm:w-4/5 bg-teal-200 m-auto py-28 lg:px-16 sm:px-6 max-sm:px-6 translate-y-[-2rem] flex justify-center items-center'>
                <p className='text-black lg:text-3xl sm:text-2xl max-sm:text-2xl text-center font-bold'>For all employment inquiries regarding Justin please view his <span className='text-white'>cover letter</span> and <span className='text-white'>resume</span> along with a <span className='text-white'>letter of recommendation</span> from one of his design professors. </p>
            </div>
            ...
            <div className='lg:p-12 sm:p-0 max-sm:p-0'>
                ...
                <div className='bg-green-600 lg:p-24 sm:p-14 max-sm:p-14 lg:w-3/5 sm:w-full max-sm:w-full'>
                ...
                <div className='flex justify-end translate-y-[-2rem]'>
                    <ul className='bg-green-700 lg:p-20 sm:p-14 max-sm:p-14 lg:w-3/5 sm:w-full max-sm:w-full text-black font-bold'>
