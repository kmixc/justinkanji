    ...
    return (
        <div>
            ...
            <div className='mt-8'>
                <div className='flex justify-center lg:translate-y-[1rem] lg:mt-0 sm:mt-10 max-sm:mt-10'>
                    <div className='bg-green-700 lg:w-3/6 sm:w-full max-sm:w-full py-6 text-center text-black font-bold'>
                        <p className='lg:text-3xl sm:text-2xl max-sm:text-2xl'>Design Project: VR Aided Architecture & Interior Design </p>
                    </div>
                </div>
                <div className='flex justify-center items-center'>
                    <div className='bg-zinc-500 text-black font-bold flex flex-col justify-center items-center lg:w-5/6 sm:w-full lg:p-18 sm:p-16 max-sm:p-8 lg:pt-12 max-sm:pt-16'>
                        ...
                        <p className='text-center text-white text-xl pt-4'>
                        ...
                        <p className='text-center py-6 text-black text-xl'>
                        ...
                        <p className='text-white text-2xl'>OPEN FULL PDF REPORT</p>
                        <a className='text-center px-6 py-4 mt-6 text-white bg-green-700 hover:text-black hover:bg-white transition text-2xl' href="https://drive.google.com/file/d/1dSJD11gTyqm9nKf8FjqeH9VEvGCxfClV/view?usp=sharing" target="work">HERE</a>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div className='flex justify-center lg:translate-y-[1rem] lg:mt-0 sm:mt-10 max-sm:mt-10'>
                    <div className='bg-orange-400 lg:w-3/6 sm:w-full max-sm:w-full py-6 text-center text-black font-bold'>
                        <p className='lg:text-3xl sm:text-2xl max-sm:text-2xl'>Reimagined Privacy Notice</p>
                    </div>
                </div>
                <div className='flex justify-center items-center'>
                    <div className='bg-blue-400 text-black font-bold flex flex-col justify-center items-center lg:w-5/6 sm:w-full lg:p-20 sm:p-16 max-sm:p-8 lg:pt-12 max-sm:pt-16'>
                        <p className='text-center py-2 text-xl'>Students were challenged to reflect on the challenges of privacy notice and consent by prototyping a reimagined privacy device.</p>
                        <p className='text-center py-2 text-xl'>Using a text-based privacy policy template provided, students had to create a usable and useful interface for displaying the privacy policy content. </p>
                        <p className='text-center pt-2 pb-8 text-xl'>VIEW OUR REIMAGINED PRIVACY NOTICE BELOW</p>
            ...
            <div>
                <div className='flex justify-center lg:translate-y-[1rem] lg:mt-0 sm:mt-10 max-sm:mt-10'>
                    <div className='bg-orange-200 lg:w-3/6 sm:w-full max-sm:w-full py-6 text-center text-black font-bold'>
                        <p className='lg:text-3xl sm:text-2xl max-sm:text-2xl'>Mapping Security & Privacy Experiences for IoT Devices</p>
                    </div>
                </div>
                <div className='flex justify-center items-center'>
                    <div className='bg-zinc-400 text-black font-bold flex flex-col justify-center items-center lg:w-5/6 sm:w-full lg:p-20 sm:p-16 max-sm:p-8 lg:pt-12 max-sm:pt-16'>
                        ...
                        <img src={CreatePrivacy} className="w-5/6 m-6" />
                        <p className='text-center text-white text-xl'>Students then had to create a user journey map, portraying a “day/week/month in the life of” story-style user journey map using the persona above.</p>
            ...
            <div>
                <div className='flex justify-center lg:translate-y-[1rem] lg:mt-0 sm:mt-10 max-sm:mt-10'>
                    <div className='bg-indigo-500 lg:w-1/6 sm:w-full max-sm:w-full py-6 text-center text-black font-bold'>
                        <p className='lg:text-3xl sm:text-2xl max-sm:text-2xl'>flex inc.</p>
                    </div>
                </div>
                <div className='flex justify-center items-center'>
                    <div className='bg-blue-200 text-black font-bold flex flex-col justify-center items-center lg:w-5/6 sm:w-full lg:p-20 sm:p-16 max-sm:p-2 lg:pt-12 max-sm:pt-16'>
                        ...
                        <p className='text-center py-2 text-xl'>In comes <span className='text-indigo-500'>flex Inc.</span></p>
                        <p className='text-center py-2 text-xl'>
            ...
            <div>
                <div className='flex justify-center lg:translate-y-[1rem] lg:mt-0 sm:mt-10 max-sm:mt-10'>
                    <div className='bg-orange-400 lg:w-3/6 sm:w-full max-sm:w-full py-6 text-center text-black font-bold'>
                        <p className='lg:text-3xl sm:text-2xl max-sm:text-2xl'>EduNest.</p>
                    </div>
                </div>
                <div className='flex justify-center items-center'>
                    <div className='bg-orange-300 text-black font-bold flex flex-col justify-center items-center lg:w-5/6 sm:w-full lg:p-20 sm:p-16 max-sm:p-8 lg:pt-8 max-sm:pt-16'>
                        ...
                        <div className='flex justify-center'>
                            <div className='bg-orange-400 w-full px-8 py-6 text-center text-black font-bold'>
                                <p className='lg:text-3xl sm:text-2xl max-sm:text-2xl'>OUR SOLUTION</p>
                            </div>
                        </div>
                        <p className='text-center py-2 text-xl'>
                ...
                <div className='flex justify-center items-center'>
                    <div className='bg-indigo-300 text-black font-bold flex flex-col justify-center items-center lg:w-5/6 sm:w-full max-sm:w-full lg:p-20 sm:p-16 max-sm:p-8 lg:pt-4 max-sm:pt-16'>
                        <div>
                            ...
                            <iframe className='lg:w-[64rem] max-sm:w-[20rem]' height="700px" src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2F0VUirXC1SxVKeGl7XcEwNr%2F302-PROTOTYPE%3Fnode-id%3D0%253A1%26t%3DIkqiqlk4U4ceBIic-1" allowfullscreen></iframe>
                        </div>
                        <div>
                            <div className='flex justify-center'>
                                <div className='bg-orange-200 my-4 w-full px-8 py-6 text-center text-black font-bold'>
